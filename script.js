...
function displayLibrary() {
	...
	</svg></button><div class="title">${ escapeHTML(book.title) }</div><div class="book-properties-grid"><div class="property">Author</div><div>${ escapeHTML(book.author) }</div><div class="property">Pages</div><div>${ book.pagesCount }</div><div class="property">Read</div><input data-index="${i}" class="read-btn" type="checkbox" ${ book.isRead ? 'checked' : '' }></div></div>`;
    }
